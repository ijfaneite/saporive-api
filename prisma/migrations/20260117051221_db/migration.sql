...
-- CreateIndex
CREATE UNIQUE INDEX "Empresa_idEmpresa_key" ON "Empresa"("idEmpresa");
...
-- AddForeignKey
ALTER TABLE "DetallePedido" ADD CONSTRAINT "DetallePedido_idPedido_fkey" FOREIGN KEY ("idPedido") REFERENCES "Pedido"("idPedido") ON DELETE CASCADE ON UPDATE CASCADE;
